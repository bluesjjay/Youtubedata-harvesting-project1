...
if question=="1.All the videos and the channel name":
    query1='''select views as videos,channel_name as channelname from channels'''
    ...
    query3='''select views as videos,channels.channel_id 
                 order by views desc limit 10'''
    cursor.execute(query3)
    mydb.commit()
    t3=cursor.fetchall()
    df3=pd.DataFrame(t3,columns=["views","channels.views"])
    st.write(df3)
    ...
    query8='''select video_title,published_date as videorelease,channel_name as channelname from channels
